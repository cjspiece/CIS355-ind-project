<?php	
	...
	if(isset($_POST['loginSubmit'])) // If the user pressed the Submit button
	{
		...
		$sql = "SELECT username, password_hash FROM users where username =:uname AND password_hash =:pass";
		$q = $pdo->prepare($sql);
		...
		// There should be at least one entry that matches the credentials otherwise the login is failed.
		if($count > 0)
		{
			$_SESSION["id"] = $sess_id;
...
<body>
	...
	<div class="col-md-4" style="margin-top: 40px;">
		...
		<a href="register.php" style="text-decoration: none;"><span class="glyphicon glyphicon-arrow-left" style="padding-right:3px;"></span> Register</a>
